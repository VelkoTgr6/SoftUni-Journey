            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Unique Identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false, comment: "Name of Product"),
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Image URL of the Product"),
                    SellerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Identifier of the product Seller"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Product Category"),
                    AddedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Added On Date"),
