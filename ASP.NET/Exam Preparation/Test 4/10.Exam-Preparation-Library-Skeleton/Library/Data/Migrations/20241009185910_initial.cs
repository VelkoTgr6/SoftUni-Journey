    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ColectorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BookId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentityUsersBooks", x => new { x.ColectorId, x.BookId });
                    table.ForeignKey(
                        name: "FK_IdentityUsersBooks_AspNetUsers_ColectorId",
                        column: x => x.ColectorId,
