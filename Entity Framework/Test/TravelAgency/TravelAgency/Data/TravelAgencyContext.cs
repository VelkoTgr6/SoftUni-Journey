...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=VELKO;Database=TravelAgency;Integrated Security=True;";
        ...
        {
            modelBuilder.Entity<TourPackageGuide>().HasKey(tpg => new{tpg.GuideId, tpg.TourPackageId});
