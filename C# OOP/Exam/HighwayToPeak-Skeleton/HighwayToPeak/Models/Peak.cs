    ...
    public class Peak : IPeak
    {
        ...
        public string Name 
        {
            ...
            private set
            {
                ...
                {
                    throw new ArgumentNullException(string.Format(ExceptionMessages.PeakNameNullOrWhiteSpace));
                }
                name = value; 
            }
        }
        ...
        public int Elevation
        {
            ...
            private set
            {
                if (value<0)
                {
                    throw new ArgumentNullException(string.Format(ExceptionMessages.PeakElevationNegative));
                }
                elevation = value;
            }
        }
